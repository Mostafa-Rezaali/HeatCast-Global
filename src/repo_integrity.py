...
def audit_repository(root: Path) -> list[CheckResult]:
    ...
    results.append(_required_tokens_check(
        ...
        (
            ...
            "def lane_cds_client(",
            "task_complete(task, deep=bool(revalidate))",
            "download_executor.submit(bounded_download, result, task)",
            '"validated_bytes": int(validated_bytes)',
            "dataset_tasks[index::lane_count]",
            "ThreadPoolExecutor(max_workers=len(lanes))",
    ...
    results.append(_required_tokens_check(
        root,
        "global.arco_era5_download_contract",
        "src/data_pipeline/download_arco_era5.py",
        (
            ...
            '"_ARRAY_DIMENSIONS"',
            '/.zattrs"',
            'self.time_origin = _parse_time_origin(',
            ...
            'task_complete(task)',
            'ECMWF S2S/ENS data are intentionally outside this module.',
        ),
    ))
    ...
    results.append(_required_tokens_check(
        ...
        (
            ...
            'Resume context produced non-cached date',
            ...
            "def cache_resume_context_start(",
            "CACHE_PROGRESS",
        ),
    ))
    ...
    results.append(_required_tokens_check(
        ...
        (
            ...
            "data_pipeline.download_arco_era5",
            "import tensorstore",
    ...
    results.append(_required_tokens_check(
        ...
        (
            ...
            "full_37-1h-0p25deg-chunk-1.zarr-v3",
            "TensorStore",
            "ARCO-ERA5 is reanalysis and does not contain",
    ...
    results.append(_result(
        "ci.installs_arco_reader",
        "tensorstore" in workflow,
        "GitHub Actions installs the production Google ARCO-ERA5 reader",
    ))
    results.append(_result(
